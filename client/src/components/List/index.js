...
export default class index extends Component {
  ...
  handleSave = book => {
    console.log(book);
    Api.saveBook({title: book.title,authors: book.authors, description: book.description,link: book.link, image: book.image}).then(savedBooks => this.setState({savedBooks:savedBooks})).catch(err => console.log(err));
  }
